            ...
            <div class="position-absolute row container w-100 m-0 d-flex justify-content-center align-items-center col-12 shadow-sm bgcolor7 border-none" style="top: 9%; left: 0; right: 0; bottom: 0;">
                ...
                <div class="position-relative container p-0 w-100 m-auto col-3 rounded shadow bg-white" style="height: 60%;">
                    ...
                    <div class="nav flex-column nav-pills m-auto" role="tablist" aria-orientation="vertical">
                        <a class="nav-link rounded-0 color5" data-toggle="pill" href="" role="tab"style="height: 10%;">Lister Questions</a>
                        <a class="nav-link rounded-0 color5" data-toggle="pill" href="./creationCompteAdmin.php" role="tab" style="height: 10%;">Créer Admin</a>
                        <a class="nav-link active rounded-0 color5" data-toggle="pill" href="" role="tab" style="height: 10%;">Lister Joueurs</a>
                        <a class="nav-link rounded-0 color5" data-toggle="pill" href="" role="tab" style="height: 10%;">Créer Questions</a>
                    </div>
                </div>

                <div class="container p-3 w-100 color5 col-6 m-auto rounded shadow bg-white d-flex flex-column justify-content-space-between align-items-stretch" style="height: 95%;">
